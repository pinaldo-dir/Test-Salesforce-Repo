...
import updateAccountAddress from '@salesforce/apex/AccountAddressCheckerUSPS.updateAccountAddress';
import getAccountAddress from '@salesforce/apex/AccountAddressCheckerUSPS.getAccountAddress';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { updateRecord } from 'lightning/uiRecordApi';
import { getRecord } from 'lightning/uiRecordApi';

export default class AccountAddressCheckerUSPS extends LightningElement {
    @api recordId;
    @api address = [];
    @track message;
