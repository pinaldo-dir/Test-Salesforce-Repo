/* Stolen and adapted from: https://github.com/pozil/sfdc-ui-lookup-lwc/blob/master/src/main/default/lwc/lookup/lookup.js */
...
export default class CashCustomLookup extends NavigationMixin(LightningElement) {
    // Public properties
    ...
    setDefaultResults(results) {
        ...
        console.log('131 _defaultSearchResults: ', this._defaultSearchResults);
    ...
    processSelectionUpdate(isUserInteraction) {
        ...
        if (isUserInteraction) {
            /* console.log('222 _curSelection: ', this._curSelection); */
            /* const selectedIds = this._curSelection.map((sel) => sel.id); */
            /* const selectedItem = this._curSelection.map((sel) => sel.name); */
    ...
    handleResultClick(event) {
        ...
        /* console.log('255 recordId: ', recordId); */
    ...
    handleBlur() {
        ...
        if(!this.hasSelection()){
            const validationEvent = new CustomEvent("blur", {detail: false});
    ...
    handleRemoveSelectedItem(event) {
        console.log('315 handleRemoveSelectedItem');
        if (this.disabled) {
            return;
        }
    ...
    handleClearSelection() {
        console.log('326 handleClearSelection');
        this._curSelection = [];
        this._hasFocus = false;
        // Process selection update
        this.processSelectionUpdate(true);
