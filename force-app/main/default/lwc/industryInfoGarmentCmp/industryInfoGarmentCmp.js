...
export default class IndustryInfoCmp extends LightningElement {                 
    ...
    renderedCallback(){
            ...
            // }
            if(this.isRenderedCallback === true && Boolean(this.isGarmentDutyFollow) && Boolean(this.isLabelsInfo)){
                this.template.querySelector('[data-id="isGarmentDutyFollow"]').value = this.isGarmentDutyFollow
            }
            if(Boolean(this.isFarmLaborContractors) && Boolean(this.farmWorker) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="farmWorker"]').value = this.farmWorker
            }
            if(Boolean(this.facilityWorkResidential) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="facilityWorkResidential"]').value = this.facilityWorkResidential
            }
            if(Boolean(this.heatRecovery) && this.isRenderedCallback === true && this.isYouFarmLaborer === true){
                this.template.querySelector('[data-id="heatRecovery"]').value = this.heatRecovery
            }
            if(Boolean(this.paidBreaks) && this.isRenderedCallback === true && this.isYouFarmLaborer === true){
                this.template.querySelector('[data-id="paidBreaks"]').value = this.paidBreaks
            }
            if(Boolean(this.separateHeatRecovery) && this.isRenderedCallback === true && this.isHeatRecPeriod === true){
                this.template.querySelector('[data-id="separateHeatRecovery"]').value = this.separateHeatRecovery
            }
            if(Boolean(this.isRateOfCompensation) && Boolean(this.writtenReqDate) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="writtenReqDate"]').value = this.writtenReqDate
            }
            if(Boolean(this.isRateOfCompensation) && Boolean(this.statementDate) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="statementDate"]').value = this.statementDate
            }
            if(Boolean(this.isRateOfCompensation) && Boolean(this.empStatementProvided) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="empStatementProvided"]').value = this.empStatementProvided
            }
            // if(Boolean(this.domesticWorkHome) && this.isRenderedCallback === true){
            //     this.template.querySelector('[data-id="domesticWorkHome"]').value = this.domesticWorkHome
            // }
            if(Boolean(this.isHouseDomesticWorker) && Boolean(this.domesticRegisteredNurse) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="domesticRegisteredNurse"]').value = this.domesticRegisteredNurse
            }
            if(Boolean(this.domesticLiveInWorkHome) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="domesticLiveInWorkHome"]').value = this.domesticLiveInWorkHome
            }
            if(Boolean(this.isHouseDomesticWorker) && Boolean(this.domesticSentByHomeAgency) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="domesticSentByHomeAgency"]').value = this.domesticSentByHomeAgency
            }
            // if(Boolean(this.personalAttendentWorkHome) && this.isRenderedCallback === true){
            //     this.template.querySelector('[data-id="personalAttendentWorkHome"]').value = this.personalAttendentWorkHome
            // }
            if(Boolean(this.isHousePersonalAttendent) && Boolean(this.personalAttendentRegisteredNurse) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="personalAttendentRegisteredNurse"]').value = this.personalAttendentRegisteredNurse
            }
            if(Boolean(this.isHousePersonalAttendent) && Boolean(this.personalAttendentLiveInWorkHome) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="personalAttendentLiveInWorkHome"]').value = this.personalAttendentLiveInWorkHome
            }
            if(Boolean(this.isHousePersonalAttendent) && Boolean(this.personalAttendentSentByHomeAgency) && this.isRenderedCallback === true){
                this.template.querySelector('[data-id="personalAttendentSentByHomeAgency"]').value = this.personalAttendentSentByHomeAgency
            }
            if(Boolean(this.isFacilityPersonalAttendent) && Boolean(this.facilityAttendentRegisteredNurse) && this.isRenderedCallback === true){
