...
import updateLocationAddress from '@salesforce/apex/LocationAddressCheckerUSPS.updateLocationAddress';
import getLocationAddress from '@salesforce/apex/LocationAddressCheckerUSPS.getLocationAddress';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { updateRecord } from 'lightning/uiRecordApi';
import { getRecord } from 'lightning/uiRecordApi';

export default class LocationAddressCheckerUSPS extends LightningElement {
    @api recordId;
    @api address = [];
    @track message;

    //@wire(getRecord, { recordId: '$recordId', fields: [ 'Account.ShippingStreet', 'Account.ShippingCity', 'Account.ShippingState', 'Account.ShippingPostalCode' ] })
