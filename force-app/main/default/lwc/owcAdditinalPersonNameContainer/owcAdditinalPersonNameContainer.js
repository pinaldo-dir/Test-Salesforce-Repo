...
export default class OwcDeniedMilegaPayContainer extends LightningElement {
    ...
    handleSectionDelete(event){
        ...
        const mileageClaimSectionDelete = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Cmp')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Cmp')
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Cmp');
    ...
    renderedCallback(){
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Cmp')
