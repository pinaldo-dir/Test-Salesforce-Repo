...
export default class OwcDeniedMilegaPayContainer extends LightningElement {
    ...
    handleSectionDelete(event){
        ...
        const mileageClaimSectionDelete = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Garment-Cmp')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Garment-Cmp')
    ...
    connectedCallback(){
        ...
        console.log('isadditionalpreview in con :: ', this.isadditionalpreview)
    }   
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Garment-Cmp');
    ...
    overTimeParentInfoSectionChild(strString, strString1,isFormPreviewMode){
        ...
        console.log('isFormPreview in Add con ::: ', isFormPreviewMode)
    ...
    renderedCallback(){
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Additinal-Person-Name-Garment-Cmp')
