...
export default class OwcDeniedMilegaPayGarmentContainer extends LightningElement {
    // Attributes
    ...
    handleSectionDelete(event){
        ...
        const mileageClaimSectionDelete = this.template.querySelectorAll('c-owc-Denied-Milega-Pay-Garment-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Denied-Milega-Pay-Garment-Child')
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Denied-Milega-Pay-Garment-Child');
    ...
    renderedCallback(){
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Denied-Milega-Pay-Garment-Child')
