...
export default class OwcEmpBusinessGarmentType extends LightningElement {
    @api deletebutton
    ...
    handleChange(event){
        ...
        switch ( event.target.name) {
            ...
            case "additionalBankruptcy":
                ...
                if(this.additionalBankruptcy ===  OWC_Yes){
    ...
    owcEmpDataForParent(isPrevious){
        ...
        if(this.isEmployerChangedName === true){
            ...
            this.template.querySelector('c-owc-Employer-Name-Changed-Garment-Cmp').handleEmployerNameChangedParent();
        }
        if(this.isEmployerChangedNameAfterEmployement === true){
            this.template.querySelector('c-owc-Successor-Section-Container-Garment-Cmp').successorSectionDetailsFromParent();
        }
    ...
    @api
    handleEvent(){
        this.isclaimantgarment === false ? this.template.querySelector('c-owc-Additinal-Person-Name-Garment-Container').handleSickLeaveTimeParent() : ''
    ...
    renderedCallback(){
        ...
        if(this.isRenderedCallback === true && (this.mileageClaimDetails) && this.mileageClaimDetails.filter(item => item.additinalPersonLastName !== undefined || item.additinalPersonFirstName !== undefined).length > 0){
            this.template.querySelector('c-owc-Additinal-Person-Name-Garment-Container').overTimeParentInfoSectionChild(this.mileageClaimDetails, this.renderMilegaClaimSection, this.isFormPreviewMode);
        }
        ...
        if(this.isRenderedCallback === true && Boolean(this.isclaimantgarment) && this.isclaimantgarment === false && this.isClaimantAdvocate === false && this.isRenderIndividualState === false){
            this.template.querySelector('[data-id="individualState"]').value = this.individualState
        }
        if(this.isRenderedCallback === true && Boolean(this.isclaimantgarment) && this.isclaimantgarment === false && this.OtherIndividualState !== undefined && this.isOtherIndividualPicklist === true){
        ...
        if(this.isRenderedCallback === true && this.employerNameChangedDetails !== undefined && this.employerNameChangedDetails !== null && this.isEmployerChangedName === true){
            this.template.querySelector('c-owc-Employer-Name-Changed-Garment-Cmp').handleEmployerNameChangedChild(this.employerNameChangedDetails, this.isFormPreviewMode);
        }
        if(this.isRenderedCallback === true && this.isEmployerChangedNameAfterEmployement === true && this.successorDetails !== null && this.successorDetails !== undefined){
            this.template.querySelector('c-owc-Successor-Section-Container-Garment-Cmp').successorSectionDetailsForChild(this.successorDetails, this.isFormPreviewMode);
        }
