...
export default class OwcEmpBusinessTypeContainerCmp extends LightningElement {
    ...
    handleSectionDelete(event){
        ...
        const employerSectionDetails = this.template.querySelectorAll('c-owc-Emp-Business-Type')
        ...
        const employerTemp = this.template.querySelectorAll('c-owc-Emp-Business-Type')
    ...
    handleSaveAsDraft(){
        const details = this.template.querySelectorAll('c-owc-Emp-Business-Type')
    ...
    renderedCallback(){
        ...
        //     this.template.querySelector('c-owc-Emp-Business-Type').owcClaimentInfo(this.isClaimantAdvocate)
        // }
