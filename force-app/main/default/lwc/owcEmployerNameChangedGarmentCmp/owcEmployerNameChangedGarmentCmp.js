...
export default class OwcEmployerNameChangedGarmentCmp extends LightningElement {
    @api deletebutton
    ...
    handleEmployerNameChangedParent(){
        ...
        if(this.IsIndividual === true){
            ...
            if(this.isIndividualRequiredSet === true ||
                    ...
                    this.isindividualEmail === true || this.isIndividualZipCode === true){
                const selectEvent = new CustomEvent('employernamechangedcustomvalidityevent', {
                    detail: { 
                        currentStep : true
                    }
                });
    ...
    handleEmployerNameChangedData(){
        const selectEvent = new CustomEvent('employernamechangedcustomevent', {
            detail : {
    ...
    @api
    handleEmployerNameChangedChild(strString,isFormPreviewMode){
