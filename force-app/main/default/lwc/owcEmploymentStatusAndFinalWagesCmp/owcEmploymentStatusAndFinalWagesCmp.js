...
export default class OwcEmploymentStatusAndFinalWagesCmp extends LightningElement {
    ...
    @api isstillIdentifiedEmpCheck = false
 ...
 //                   this.template.querySelector('[data-id="paidByCheck"]').value = null;
            ...
            case "stillIdentifiedEmp":
                ...
                this.handlestillIdentifiedEmpFocus()
            ...
            case "noticeBeforeQuiting":
                ...
                this.noticeBeforeQuiting != null ? this.isCustomValidationVisible = false : this.isCustomValidationVisible = true;
            break; 
            ...
            case "personNameWhoDischargeYou":
                ...
                this.personNameWhoDischargeYou != null ? this.isCustomValidationVisible = false : this.isCustomValidationVisible = true;
            break; 
    ...
    handleHireDateFocus(){
        ...
        if(hireDate.value == null || hireDate.value == undefined || hireDate.value.trim() == ''){
            hireDate.setCustomValidity(customLabelValues.OWC_required_field_error_msg)
    ...
    handleHowWereYourWagesPaidFocus(){
        ...
        if(howWereYourWagesPaid.value == undefined || howWereYourWagesPaid.value == null || howWereYourWagesPaid.value.trim() == ''){
            howWereYourWagesPaid.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
            this.ishowWereYourWagesPaid = true;
        }
        else{
     ...
     //Are you still working for identified employer focus
     handlestillIdentifiedEmpFocus(){
        let stillIdentEmp = this.template.querySelector('[data-id="stillIdentifiedEmp"]');            
        if(stillIdentEmp.value == undefined || stillIdentEmp.value == null || stillIdentEmp.value.trim() == ''){
            stillIdentEmp.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
            this.isstillIdentifiedEmpCheck = true;
        }
        else{
            stillIdentEmp.setCustomValidity("");
            this.isstillIdentifiedEmpCheck = false;
        }
        stillIdentEmp.reportValidity();
    }
     //Select Any One
    handleselectAnyOneFocus(){
        ...
        if(selectAnyOne.value == undefined || selectAnyOne.value == null || selectAnyOne.value.trim() == ''){
            selectAnyOne.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
    ...
    handleExplanationFocus(){
        ...
        if(Explanation.value == undefined || Explanation.value == null || Explanation.value.trim() == ''){
            Explanation.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
    ...
    //Check bounce focus
    handleCheckBouncFocus(){
        let CheckBounce = this.template.querySelector('[data-id="paidByCheck"]');  
        if(CheckBounce.value == undefined || CheckBounce.value == null || CheckBounce.value == ''){
            CheckBounce.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
            this.isCheckBounce = true;
        }
        else{
            CheckBounce.setCustomValidity("");
            this.isCheckBounce = false;
        }
        CheckBounce.reportValidity();
    }
    ...
    handleFinalPaymentDateFocus(){
        ...
        if(finalPaymentDate.value == null || finalPaymentDate.value == undefined || finalPaymentDate.value.trim() == ''){
            finalPaymentDate.setCustomValidity(customLabelValues.OWC_required_field_error_msg)
    ...
    handleFinalPaymentExplanationFocus(){
        ...
        if(finalPaymentExplanation.value == undefined || finalPaymentExplanation.value == null || finalPaymentExplanation.value.trim() == ''){
            finalPaymentExplanation.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
        }
        else{
    ...
    handleDischargedExplanationFocus(){
        ...
        if(dischargedExplanation.value == undefined || dischargedExplanation.value == null || dischargedExplanation.value.trim() == ''){
            dischargedExplanation.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
        }
        else{
    ...
    handleEmpStatusAndWagesEvent(){  
        const selectEvent = new CustomEvent('empstatusandfinalwagescustomevent', {
            detail: {
                ...
                isstillIdentifiedEmpCheck : this.isstillIdentifiedEmpCheck,
    ...
    owcEmpStatusAndWagesDataForParent(){
        ...
        if(this.howWereYourWagesPaid === undefined || this.howWereYourWagesPaid === null || this.howWereYourWagesPaid === ''){
            this.handleHowWereYourWagesPaidFocus()
            let howWereYourWagesPaid = this.template.querySelector('[data-id="howWereYourWagesPaid"]');
            this.ishowWereYourWagesPaid === true ? howWereYourWagesPaid.focus() : ''
            this.ishowWereYourWagesPaid === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
        }
        if(this.isOther === true){
            this.handleExplanationFocus();
            let Explanation = this.template.querySelector('[data-id="Explanation"]');
            this.isExplanation === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
            this.isExplanation === true ? Explanation.focus() : ''
        }   
        if(this.isCheck === true){
            this.handleCheckBouncFocus();
            let CheckBounce = this.template.querySelector('[data-id="paidByCheck"]');
            this.isCheckBounce === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
            this.isCheckBounce === true ? CheckBounce.focus() : ''
        }  
        if(this.isChequeReplaced === true  && this.chequeReplacedDate != null){
            this.handlechequeReplacedDateFocus();
            let chequeReplacedDate = this.template.querySelector('[data-id="chequeReplacedDate"]');
            this.ischequeReplacedDate === true ? chequeReplacedDate.focus() : ''
            this.ischequeReplacedDate === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
        }
        if(this.stillIdentifiedEmp === undefined || this.stillIdentifiedEmp === null || this.stillIdentifiedEmp === ''){
            this.handlestillIdentifiedEmpFocus()
            let stillIdentifiedEmp = this.template.querySelector('[data-id="stillIdentifiedEmp"]');
            this.isstillIdentifiedEmpCheck === true ? stillIdentifiedEmp.focus() : ''
            this.isstillIdentifiedEmpCheck === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
        }
        if( this.isstillIdentifiedEmp === true){
            this.handleselectAnyOneFocus()
            let selectAnyOne = this.template.querySelector('[data-id="selectAnyOne"]');
            this.isselectAnyOne === true ? selectAnyOne.focus() : ''
            this.isselectAnyOne === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
        }
        if( this.QuitDateTemplate === true){
            ...
            let receivedFinalQuitPayment = this.template.querySelector('[data-id="receivedFinalPayment"]');
            if(quitDateValue.value === undefined || quitDateValue.value === null || quitDateValue.value.trim() === ''){
                this.isquitDateValue = true;
            }else{
            ...
            if(noticeValue.value === undefined || noticeValue.value === null || noticeValue.value.trim() === ''|| noticeValue.value === '--Select--'){
                this.isnoticeValue = true;
            }else{
                this.isnoticeValue = false;
            }
            if(receivedFinalQuitPayment.value === undefined || receivedFinalQuitPayment.value === null || receivedFinalQuitPayment.value.trim() === ''){
                this.isreceivedFinalQuitPayment = true
            }else{
                this.isreceivedFinalQuitPayment = false
            }
            if(this.isquitDateValue === true ||  this.isnoticeValue === true || this.isreceivedFinalQuitPayment === true ) {
                this.handleCustomValidityEvent()
                this.customValidationMsg = customLabelValues.OWC_EmpStatusRequiredMsg 
                this.isCustomValidationVisible = true 
            }else{
        ...
        if( this.DischargeDateTemplate === true){
            let dischargedDate = this.template.querySelector('[data-id="dischargedDate"]');
            let personNameWhoDischargeYou = this.template.querySelector('[data-id="personNameWhoDischargeYou"]');
            let receivedFinalPayment2 = this.template.querySelector('[data-id="receivedFinalPayment2"]');

            if(dischargedDate.value === undefined || dischargedDate.value === null || dischargedDate.value.trim() === ''){
                this.isdischargedDate = true;
            }else{
                this.isdischargedDate = false;
            }
            if(personNameWhoDischargeYou.value === undefined || personNameWhoDischargeYou.value === null || personNameWhoDischargeYou.value.trim() === ''){
                this.ispersonNameWhoDischargeYou = true
            }else{
                this.ispersonNameWhoDischargeYou = false
            }
            if(receivedFinalPayment2.value === undefined || receivedFinalPayment2.value === null || receivedFinalPayment2.value == ''){
                this.isreceivedFinalDischargePayment  = true
            }else{
                this.isreceivedFinalDischargePayment = false
            }
            if(this.isdischargedDate === true || this.ispersonNameWhoDischargeYou === true || this.isreceivedFinalDischargePayment === true) {
                this.handleCustomValidityEvent()
                this.customValidationMsg = customLabelValues.OWC_EmpStatusRequiredMsg 
                this.isCustomValidationVisible = true 
            }
        ...
        if(this.isreceivedFinalPayment === true){
            let finalPaymentDate = this.template.querySelector('[data-id="finalPaymentDate"]');
            let finalPaymentDateValue = this.finalPaymentDate
            this.isfinalPaymentDate = this.hireDateValidityChecker(finalPaymentDate, finalPaymentDateValue);
            this.isfinalPaymentDate === true ? finalPaymentDate.focus() : ''
            this.isfinalPaymentDate === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
        }
        ...
        // }
        if(this.isreceivedFinalPayment2 === true){
            let DateFS2 = this.template.querySelector('[data-id="DateFS2"]');
            let DateFS2Value = this.DateFS2
            this.isDateFS2 = this.hireDateValidityChecker(DateFS2, DateFS2Value);
            this.isDateFS2 === true ? DateFS2.focus() : ''
            this.isDateFS2 === true ? this.handleCustomValidityEvent() : this.handleEmpStatusAndWagesEvent();
        }
    ...
    owcEmpStatusAndWagesDataForChild(strString, isFormPreviewMode){
        ...
        this.CheckBounce = strString.CheckBounce
