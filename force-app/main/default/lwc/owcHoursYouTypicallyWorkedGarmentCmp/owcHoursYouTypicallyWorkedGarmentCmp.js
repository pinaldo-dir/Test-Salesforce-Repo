...
export default class OwcHoursYouTypicallyWorkedGarmentCmp extends LightningElement {
    ...
    owcHoursYouWorkedForParent(){
        if(this.isSameWeekDaysAndHours === true || this.isDaysOrWeekVaried === true){
            ...
            if(this.isSameWeekDaysAndHours === true){
                this.template.querySelector('c-owc-Hours-You-Typically-Garment-Calendar').getWeekDaysDetails();
            }
        }      
        this.handleEvent();
    }
    ...
    owcHoursYouWorkedForChild(strString, isFormPreviewMode ){
        ...
        // this.timeEntriesDetail = strString.timeEntriesDetail
        // this.isSameWeekDaysAndHours === true && strString.timeEntriesDetail.length > 0 ? this.template.querySelector('c-owc-Hours-You-Typically-Garment-Calendar').setTimeEntriesOnPrev() : '';
