...
export default class OwcInsufficientFundClaimContainer extends LightningElement {
    // Attributes
    ...
    handleSectionDelete(event){
        ...
        const fundClaimSectionDelete = this.template.querySelectorAll('c-owc-Insufficient-Fund-Claim-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Insufficient-Fund-Claim-Child')
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Insufficient-Fund-Claim-Child');
    ...
    renderedCallback(){
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Insufficient-Fund-Claim-Child')
