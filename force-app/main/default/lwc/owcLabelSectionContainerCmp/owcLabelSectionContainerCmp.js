...
export default class OwcLabelSectionContainerCmp extends LightningElement {
   ...
   @api get disableAddMore(){
    ...
    handleLabelSectionDelete(event){
        ...
        const labelSectionDetails = this.template.querySelectorAll('c-owc-Label-Section-Cmp')
        ...
        const labelTemp = this.template.querySelectorAll('c-owc-Label-Section-Cmp')
