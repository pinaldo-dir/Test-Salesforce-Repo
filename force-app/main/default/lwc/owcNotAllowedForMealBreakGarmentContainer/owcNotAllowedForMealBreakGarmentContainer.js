...
export default class OwcNotAllowedForMealBreakGarmentContainer extends LightningElement {
    // Attributes
    ...
    handleSectionDelete(event){
        ...
        const mealBreakSectionDelete = this.template.querySelectorAll('c-owc-Not-Allowed-Meal-Break-Garment-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Not-Allowed-Meal-Break-Garment-Child')
    ...
    handlePOWDetails(paymentOfWagesDetails, isFormPreviewMode){
        ...
        const temp = this.template.querySelectorAll('c-owc-Not-Allowed-Meal-Break-Garment-Child');
        if(temp.length > 0){
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Not-Allowed-Meal-Break-Garment-Child');
    ...
    renderedCallback(){
        ...
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Not-Allowed-Meal-Break-Garment-Child')
