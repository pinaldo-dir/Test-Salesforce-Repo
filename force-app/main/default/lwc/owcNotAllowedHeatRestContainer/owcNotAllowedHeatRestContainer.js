...
export default class OwcNotAllowedHeatRestContainer extends LightningElement {
    // Attributes
    ...
    handleSectionDelete(event){
        ...
        const restClaimSectionDelete = this.template.querySelectorAll('c-owc-Not-Allowed-Heat-Rest-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Not-Allowed-Heat-Rest-Child')
    ...
    handlePOWDetails(paymentOfWagesDetails, isFormPreviewMode){
        ...
        const temp = this.template.querySelectorAll('c-owc-Not-Allowed-Heat-Rest-Child');
        if(temp.length > 0){
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Not-Allowed-Heat-Rest-Child');
    ...
    renderedCallback(){
        ...
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Not-Allowed-Heat-Rest-Child')
