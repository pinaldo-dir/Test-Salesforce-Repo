...
export default class OwcNotAllowedRestBreakGarmentContainer extends LightningElement {
     // Attributes
     ...
     handleSectionDelete(event){
         ...
         const restBreakSectionDelete = this.template.querySelectorAll('c-owc-Not-Allowed-Rest-Break-Garment-Child')
         ...
         // const employerTemp = this.template.querySelectorAll('c-owc-Not-Allowed-Rest-Break-Garment-Child')
     ...
     handlePOWDetails(paymentOfWagesDetails, isFormPreviewMode){
         ...
         const temp = this.template.querySelectorAll('c-owc-Not-Allowed-Rest-Break-Garment-Child');
         if(temp.length > 0){
     ...
     handleSickLeaveTimeParent(){
         const overTimeTemplate = this.template.querySelectorAll('c-owc-Not-Allowed-Rest-Break-Garment-Child');
     ...
     renderedCallback(){
         ...
         if(this.isrenderedCallback === true){
             ...
             const details = this.template.querySelectorAll('c-owc-Not-Allowed-Rest-Break-Garment-Child')
