...
export default class OwcNotPaidSickLeaveGarmentContainer extends LightningElement {
    // Attributes
    ...
    handlePOWDetails(paymentOfWagesDetails, isFormPreviewMode){
        ...
        const temp = this.template.querySelectorAll('c-owc-Not-Paid-Sick-Leave-Garment-Child');
        if(temp.length > 0){
    ...
    handleSectionDelete(event){
        ...
        const sickLeaveSectionDelete = this.template.querySelectorAll('c-owc-Not-Paid-Sick-Leave-Garment-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Not-Paid-Sick-Leave-Garment-Child')
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Not-Paid-Sick-Leave-Garment-Child');
    ...
    renderedCallback(){
        ...
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Not-Paid-Sick-Leave-Garment-Child')
