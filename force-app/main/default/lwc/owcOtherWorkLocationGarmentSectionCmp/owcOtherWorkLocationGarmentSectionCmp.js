...
export default class OwcOtherWorkLocationGarmentSectionCmp extends LightningElement {
    ...
    handleOtherBusinessStreetAddressFocus(){
        let otherBusinessStreetAddress = this.template.querySelector('[data-id="otherBusinessStreetAddress"]');
        if(otherBusinessStreetAddress.value.trim() == undefined || otherBusinessStreetAddress.value.trim() == '' || otherBusinessStreetAddress.value.trim() == null){
            // otherBusinessStreetAddress.setCustomValidity(OWC_required_field_error_msg);
        }
        else{
            otherBusinessStreetAddress.setCustomValidity("");
        }
        otherBusinessStreetAddress.reportValidity();
    }
    ...
    handleOtherBusinessZipCodeFocus(){
        ...
        if(otherBusinessZipCode.value === undefined || otherBusinessZipCode.value === null || otherBusinessZipCode.value.trim() === ''){
            ...
            otherBusinessZipCode.setCustomValidity('Please enter valid Zip Code.')
        }
    ...
    otherWorkLocationDetailsFromParent(isPrevious){
        ...
        if(this.isBusinessAddressDifferent === true){
            ...
            if(this.NotProceed === true   || this.isZipCodeValid === true || this.isPhoneChecked === true){
