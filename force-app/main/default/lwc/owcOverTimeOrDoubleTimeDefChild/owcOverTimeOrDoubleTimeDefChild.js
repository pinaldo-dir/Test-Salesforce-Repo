...
import getOtDtYears from '@salesforce/apex/OWCWageDeficienciesController.getOtDtYears';
...
export default class OwcOverTimeOrDoubleTimeDefChild extends LightningElement {
    ...
    @wire(getOtDtYears)
    getOtDtYears({data, error}){
        if(data){
            this.overtimeYearSelection = data;
        }else{
            this.errorMsg = error;
        }
    }
    ...
    @track isClaimDateError
    @track isClaimHoursError
    @track isClaimAmountOwedError
    @track isValueRequiredError
    ...
    handleChange(event){
        ...
        if(this.violationTypeVariablesForAdditional !== undefined){
            ...
            let otdtAmountOwedId = this.template.querySelector('[data-id="overtimeAdditinalBalance"]');
            ...
            this.isClaimDateError = this.handlePOWDateValidity(startDateId,endDateId,startDateId.value,endDateId.value)
            this.isClaimHoursError = this.handleRequiredField(otHoursId)
            this.isClaimAmountOwedError = this.handleRequiredField(otdtAmountOwedId)
        }
        ...
        if(this.violationTypeVariablesForOneHourly !== undefined){
            ...
            let otBalanceOwedId = this.template.querySelector('[data-id="overtimeBalanceOwed"]');
            ...
            this.isClaimDateError = this.handlePOWDateValidity(startDateId,endDateId,startDateId.value,endDateId.value)
            this.isClaimHoursError = this.handleRequiredField(ot19HourTimeId)
            this.isClaimAmountOwedError = this.handleRequiredField(otBalanceOwedId)
        ...
        if(this.violationTypeVariablesForOneHourlyRecs !== undefined){
            ...
            let dtBalanceOwedId = this.template.querySelector('[data-id="doubleTimeOwedValue"]')
            ...
            this.isClaimDateError = this.handlePOWDateValidity(startDateId,endDateId,startDateId.value,endDateId.value)
            this.isClaimHoursError = this.handleRequiredField(dt19Id)
            this.isClaimAmountOwedError = this.handleRequiredField(dtBalanceOwedId)
        }
    ...
    checkOT28DecimalValidity(values, Ids){
        ...
        if(Boolean(values) && values.match(decimalCheckRegex)){
            ...
            Ids.setCustomValidity(this.customLabelValues.OWC_valid_hours_input_error_msg);
            Ids.reportValidity();
    ...
    checkCalendarYearForOT10(startDate, endDate){
        ...
        if(Boolean(this.overtimeYearSelection)){
            if(Number(startDate) < this.overtimeYearSelection[0].Year__c && Number(endDate) < this.overtimeYearSelection[0].Year__c){
            ...
            else if(Number(startDate) == this.overtimeYearSelection[0].Year__c && Number(endDate) == this.overtimeYearSelection[0].Year__c){
            ...
            else if(Number(startDate) == this.overtimeYearSelection[1].Year__c && Number(endDate) == this.overtimeYearSelection[1].Year__c){
                this.isCaseIssueOT13 = false;
                this.isCaseIssueOT13_1 = false;
            ...
            else if(Number(startDate) == this.overtimeYearSelection[2].Year__c && Number(endDate) == this.overtimeYearSelection[2].Year__c){
                this.isCaseIssueOT13 = false;
                this.isCaseIssueOT13_1 = false;
                this.isCaseIssueOT13_2 = false;
    ...
    handlePOWDateValidity(startDateId, endDateId, startDate, endDate){
        ...
        console.log('console handle date value', startDate)


        startDate != '' && startDate != null ? startDate = new Date(startDate.toString()) : ''

        endDate != '' && endDate != null ? endDate = new Date(endDate.toString()) : ''

        console.log('console handle string',endDate )
    ...
    handleRequiredField(FieldId){
        console.log('console handle hour/amount value', FieldId.value)
        ...
        .then(result => {
            if(result){
                for(var i=0; i<result.length; i++){
                    ...
                    result[i].name === 'VTV1450' || result[i].name === 'VTV1451' || result[i].name === 'VTV1452' || result[i].name === 'overtimeBalanceOwed' ? result[i].isRequiredField = true : result[i].isRequiredField = false
                }
    ...
    handleOverTimeParentData(){
       // Add focus on error fields
        let startDateId = this.template.querySelector('[data-id="VTV1450"]');
        let endDateId = this.template.querySelector('[data-id="VTV1451"]');
        let ot19StartDateId = this.template.querySelector('[data-id="VTV1030"]');
        let ot19EndDateId = this.template.querySelector('[data-id="VTV1031"]');
        let dt10startDateId = this.template.querySelector('[data-id="VTV0052"]');
        ...
        let dt16HoursId = this.template.querySelector('[data-id="VTV1635"]');
        let ot28HoursId = this.template.querySelector('[data-id="VTV1501"]');
        let otBalanceId = this.template.querySelector('[data-id="overtimeBalanceOwed"]');
        let dtBalanceId = this.template.querySelector('[data-id="doubleTimeOwedValue"]');
        let otdtBalanceId = this.template.querySelector('[data-id="overtimeAdditinalBalance"]');

        console.log('console claim double time :::',this.claimDoubleTimeOnly)
        console.log('console Both/dont know',this.isBothOverTime)
        console.log('console overtime',this.isDoubleTimeClaim)
        console.log('console double time',this.isDoubleTimeOnly)

        if(this.isDoubleTimeClaim ){

            this.isClaimDateError = this.handlePOWDateValidity(startDateId,endDateId,startDateId.value,endDateId.value) 
            this.isClaimAmountOwedError = this.handleRequiredField(otBalanceId)
            this.isClaimHoursError = this.handleRequiredField(ot19HoursId)
            this.isClaimPeriodError = this.checkClaimPeriod(startDateId.value,endDateId.value,startDateId,endDateId)
            console.log('console isClaimPeriod' ,this.isClaimPeriodError)

        }
        else if(this.isDoubleTimeOnly){

            this.isClaimDateError = this.handlePOWDateValidity(dt10startDateId,dt10endDateId,dt10startDateId.value,dt10endDateId.value)
            this.isClaimAmountOwedError = this.handleRequiredField(dtBalanceId) 
            this.isClaimHoursError = this.handleRequiredField(dt19HoursId)
            this.isClaimPeriodError = this.checkClaimPeriod(dt10startDateId.value,dt10endDateId.value,dt10startDateId,dt10endDateId)
        }

        else if(this.isBothOverTime){
            
            this.isClaimDateError = this.handlePOWDateValidity(ot19StartDateId,ot19EndDateId,ot19StartDateId.value,ot19EndDateId.value)
            this.isClaimAmountOwedError = this.handleRequiredField(otdtBalanceId)
            this.isClaimHoursError = (this.handleRequiredField(otHoursId) || this.handleRequiredField(dtHoursId))
            this.isClaimPeriodError = this.checkClaimPeriod(ot19StartDateId.value,ot19EndDateId.value,ot19StartDateId,ot19EndDateId)
        }
       ...
       // Add focus on endDate field if claim period year is not same.
        this.isClaimPeriodError === true && Boolean(startDateId) && Boolean(startDateId.value) && this.isDoubleTimeClaim === true ? startDateId.focus() : ''
        this.isClaimPeriodError === true && Boolean(endDateId) && Boolean(endDateId.value) && this.isDoubleTimeClaim === true ? endDateId.focus() : ''
        this.isClaimPeriodError === true && Boolean(ot19StartDateId) && Boolean(ot19StartDateId.value) && this.isDoubleTimeOnly === true ? ot19StartDateId.focus() : ''
        this.isClaimPeriodError === true && Boolean(ot19EndDateId) && Boolean(ot19EndDateId.value) && this.isDoubleTimeOnly === true ? ot19EndDateId.focus() : ''
        this.isClaimPeriodError === true && Boolean(dt10startDateId) && Boolean(dt10startDateId.value) && this.isBothOverTime === true ? dt10startDateId.focus() : ''
        this.isClaimPeriodError === true && Boolean(dt10endDateId) && Boolean(dt10endDateId.value) && this.isBothOverTime === true ? dt10endDateId.focus() : ''
        ...
        if(this.isValueRequiredError === true || this.isClaimAmountOwedError === true || this.isClaimDateError === true || this.isClaimHoursError === true || this.isOT28DecimalValid === true || this.isDT16DecimalValid === true || this.isDT19DecimalValid === true || this.isOT19DecimalValid === true || this.isDecimalValid === true || this.isEndDateReq === true || this.isClaimPeriodError === true){
