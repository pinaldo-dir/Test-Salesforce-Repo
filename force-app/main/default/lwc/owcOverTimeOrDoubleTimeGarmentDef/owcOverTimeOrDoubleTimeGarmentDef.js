...
export default class OwcOverTimeOrDoubleTimeGarmentDef extends LightningElement {
    // Attributes
    ...
    handleSectionDelete(event){
        ...
        const overTimeSectionDetails = this.template.querySelectorAll('c-owc-Over-Time-Or-Double-Time-Def-Garment-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Over-Time-Or-Double-Time-Def-Garment-Child')
    ...
    handlePOWDetails(paymentOfWagesDetails, isFormPreviewMode){
        ...
        const temp = this.template.querySelectorAll('c-owc-Over-Time-Or-Double-Time-Def-Garment-Child');
        if(temp.length > 0){
    ...
    handleOverTimeOrDoubleTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Over-Time-Or-Double-Time-Def-Garment-Child');
    ...
    renderedCallback(){
        ...
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Over-Time-Or-Double-Time-Def-Garment-Child')
