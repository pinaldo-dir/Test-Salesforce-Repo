...
import getAccountDetails from '@salesforce/apex/owcNewWageIntakeFormController.getRelatedAccount';
...
import intakeOrigin from '@salesforce/apex/owcNewWageIntakeFormController.intakeOrigin';
import mainMethod from '@salesforce/apex/owcNewWageIntakeFormController.mainMethod';
import empDetails from '@salesforce/apex/owcNewWageIntakeFormController.empDetails'
...
export default class OwcPaperIntakeClaimantInfo extends LightningElement {
...
preliminarySectionBirthdayValidityChecker(ids, values){
    ...
    handleFormSubmit(event){
        console.log('this.isaccountid:::',this.isaccountid)
        if(this.isaccountid === false){
            let yourselfFirstName = this.template.querySelector('[data-id="yourselfFirstName"]');
            ...
            if( this.isFirstName === true || this.isLastName === true || this.isBirthdate === true || this.isZipCode === true ||
                 this.isZipCodeValid === true  || this.isCaseRecDate === true || this.isIntakeOrigin === true){
    ...
    //     if(this.isFirstName === true || this.isLastName  === true || this.isZipCode === true || 
    ...
    handleSubmit(event){
        this.isLoading = true;
        const redirectUrl = `${window.location.origin}/lightning/r/Account/${this.currentrecordid}/view`;
        mainMethod({
