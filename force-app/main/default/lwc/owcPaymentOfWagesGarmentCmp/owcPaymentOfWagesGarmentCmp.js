...
export default class OwcPaymentOfWagesGarmentCmp extends LightningElement {
...
//ConnectedCall back Method 
 ...
 isRenderDifferentHourAdd
    ...
    handleDifferentAdditional(differentHourAdditionalvalue, differentHourAdditionalCount){
        ...
        this.renderDifferentHourAdditonalSection.length = 0
        this.isDifferentHourAdditionalInfoSection = true
        if(Boolean(differentHourAdditionalCount)){
  ...
  isRenderSalaryRateAdd
     ...
     handleSalaryRateAdditional(salaryRateAdditionalvalue, salaryRateAdditionalCount){
         ...
         this.renderSalaryRateAdditonalSection.length = 0
         this.isSalaryRateAdditionalSection = true
         if(Boolean(salaryRateAdditionalCount))
         {
 ...
 isRenderPieceRateAdd
    ...
    handlePieceRateAdditional(pieceRateAdditionalvalue, pieceRateAdditionalCount){
        ...
        this.renderPieceRateAdditonalSection.length = 0
        this.isPieceRateAdditionalSection = true
        if(Boolean(pieceRateAdditionalCount)){
    ...
    */
    ...
    //    }
        ...
        return ( this.isPOWDateAcceptable === true || this.ispaidAmountPerHour === true || this.ispromisedAmountPerHour === true || this.isNotAdditionalPaidAmountPerHour === true || this.isNotAdditionalpromisedAmountPerHour === true || this.isPOWDateAcceptableAdditional === true
                 ...
                 || this.isNotpaidAmountForEachDay === true || this.isNotpromisedAmountForEachDay === true || this.isNotEachPayRateDateAcceptable === true || this.isNotAdditionalpaidAmountForEachDay === true || this.isNotAdditionalpromisedAmountForEachDay === true || this.isNotAdditionaleachPayRateBegDate === true
                 || this.isNotPaidCommissionRate === true || this.isNotpromisedCommissionRate === true || this.isNotCommissionRateDateAcceptable === true
                 || this.isNotpaidPieceRate === true || this.isNotpromisedPieceRate === true || this.isNotpieceRateTotalEarned === true || this.isNotpieceRateTotalPaid === true || this.isNotpieceRateBegDate === true || this.isNotnumberOfUnits === true 
    ...
    handleHourlyAdditional(oneHourlyAdditionalvalue, OneHourlyAdditionalCount){
        ...
        this.renderOneHourlyAdditonalSection.length = 0
        this.isOneHourlyAdditionalSection = true
        if(Boolean(OneHourlyAdditionalCount)){
