...
export default class owcPreliminarySectionCmp extends LightningElement {
    error;
    stack;
...
@api isClaimantConfirmation = false
    ...
    .then(result => {
        if(result){
            if(this.WageClaimSubmit === 'Representative' && this.isIndividualRepresentation === true){
             ...
             this.individualRepState === null || this.individualRepState === undefined || this.individualRepState === '' ? result.state == null ? this.individualRepState = '' : this.individualRepState = result.state : this.individualRepState = this.individualRepState;
    ...
    handleIndividualRepPhoneTypeFocus(event){
        let individualRepPhoneType = this.template.querySelector('[data-id="individualRepPhoneType"]');
                if(individualRepPhoneType.value == undefined || individualRepPhoneType.value == null || individualRepPhoneType.value == ''){
                    individualRepPhoneType.setCustomValidity(customLabelValues.OWC_required_field_error_msg);
                }
                else{
        ...
        switch ( event.target.name ) {
            ...
            case "representativeAdvocateType":
                ...
                if(this.representativeAdvocateType === 'Individual'){
                    ...
                    this.individualRepState === '' || this.individualRepState === null || this.individualRepState === undefined ? this.individualRepState = '' : this.individualRepState = this.individualRepState
                    ...
                    this.isOrganizationRepresentation = false
                    this.lawfirmRepState === '' || this.lawfirmRepState === null || this.lawfirmRepState === undefined ? this.lawfirmRepState = '' : this.lawfirmRepState = this.lawfirmRepState
                    ...
                    this.organizationRepState === '' || this.organizationRepState === null || this.organizationRepState === undefined ? this.organizationRepState = '' : this.organizationRepState = this.organizationRepState
                    this.WageClaimSubmit === 'Yourself' ? this.resetIndividualRepAdvocateTemplate() : ''
                    this.WageClaimSubmit === 'Yourself' ? this.resetLawFirmRepAdvocateTemplate() : ''
                }
            ...
            case "countryCodelawfirmRepStatePhone":
                ...
                break;
            case "repcellPhoneEntered":
                this.isrepCellPhoneEntered = event.target.checked;
                console.log('isrepCellPhoneEntered :::', this.isrepCellPhoneEntered);
                break;
        }
    }
    ...
    handlePreliminaryEvent(){
        if(this.isYourself === true || this.isIndividualRepresentation === true || this.isLawFirmRepresentation === true || this.isOrganizationRepresentation === true){
            this.template.querySelector('c-owc-Claimant-Emplyee-Section-Cmp').handleClaimantEvent();
        }
        const selectEvent = new CustomEvent('claimantemployeecustomevent', {
            detail: { 
                ...
                isrepCellPhoneEntered : this.isrepCellPhoneEntered,
                repcellPhoneEntered : this.repcellPhoneEntered,
    ...
    owcClaimantEmployeeDataForParent(){
        ...
        if(this.isYourself === true){
            this.template.querySelector('c-owc-Claimant-Emplyee-Section-Cmp').handleClaimantEmployeeParent(false);
        ...
        if(this.isIndividualRepresentation === true){
            this.template.querySelector('c-owc-Claimant-Emplyee-Section-Cmp').handleClaimantEmployeeParent();
            let individualRepEmail = this.template.querySelector('[data-id="individualRepEmail"]');
            let individualRepPhoneType = this.template.querySelector('[data-id="individualRepPhoneType"]');
                let individualRepFirstName = this.template.querySelector('[data-id="individualRepFirstName"]');
            ...
            if(this.isFieldSetValid === true || this.lawFirmRepZipCode === true || this.islawfirmRepEmailValid === true || this.isWebsiteAddressCorrect === true || this.isValidityTrue === true ){
                const validateEvent = new CustomEvent('validityevent', {
                                detail: {
                                    currentStep : true
                                }
    ...
    owcClaimantEmployeeInfoForChild(strString, isFormPreviewMode){
        ...
        this.isrepCellPhoneEntered = strString.isrepCellPhoneEntered
        this.orgcellPhoneEntered = this.orgcellPhoneEntered
    ...
    renderedCallback(){
        ...
        if(this.isRenderedCallback === false && this.representativeAdvocateType === 'Organization' && this.isOrganizationStatePicklist === false){
            this.template.querySelector('[data-id="organizationRepState"]').value = '';
        ...
        if(this.isRenderedCallback === true && (this.isYourself === true || this.isIndividualRepresentation === true || this.isLawFirmRepresentation === true || this.isOrganizationRepresentation === true)){
            this.template.querySelector('c-owc-Claimant-Emplyee-Section-Cmp').handleClaimantChild(this.claimantDetails, this.isFormPreviewMode)
        }
