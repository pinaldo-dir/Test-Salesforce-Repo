...
export default class OwcReportingTimePayClaimGarmentContainer extends LightningElement {
    // Attributes
    ...
    handleSectionDelete(event){
        ...
        const payClaimSectionDelete = this.template.querySelectorAll('c-owc-Reporting-Time-Pay-Claim-Garment-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Reporting-Time-Pay-Claim-Garment-Child')
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Reporting-Time-Pay-Claim-Garment-Child');
    ...
    handlePOWDetails(paymentOfWagesDetails, isFormPreviewMode){
        ...
        const temp = this.template.querySelectorAll('c-owc-Reporting-Time-Pay-Claim-Garment-Child');
        if(temp.length > 0){
    ...
    renderedCallback(){
        ...
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Reporting-Time-Pay-Claim-Garment-Child')
