...
export default class OwcSplitShiftPremiumContainer extends LightningElement {
    // Attributes
    ...
    handleSectionDelete(event){
        ...
        const splitShiftSectionDeleted = this.template.querySelectorAll('c-owc-Split-Shift-Premium-Child')
        ...
        // const employerTemp = this.template.querySelectorAll('c-owc-Split-Shift-Premium-Child')
    ...
    handlePOWDetails(paymentOfWagesDetails, isFormPreviewMode){
        ...
        const temp = this.template.querySelectorAll('c-owc-Split-Shift-Premium-Child');
        if(temp.length > 0){
    ...
    handleSickLeaveTimeParent(){
        const overTimeTemplate = this.template.querySelectorAll('c-owc-Split-Shift-Premium-Child');
    ...
    renderedCallback(){
        ...
        if(this.isrenderedCallback === true){
            ...
            const details = this.template.querySelectorAll('c-owc-Split-Shift-Premium-Child')
