...
export default class OwcSuccessorSectionGarmentCmp extends LightningElement {
    ...
    owcSuccessorDataForParent(){
            this.template.querySelector('c-owc-Employer-Name-After-Employement-Garment').handleEmployerNameChangedParent();
    ...
    renderedCallback(){
        if(this.isRenderedCallback === true && this.employerNameAfterEmployementDetails !== undefined && this.employerNameAfterEmployementDetails !== null){
            this.template.querySelector('c-owc-Employer-Name-After-Employement-Garment').handleEmployerNameAfterEmployementChild(this.employerNameAfterEmployementDetails, this.isFormPreviewMode);
        }
    }
