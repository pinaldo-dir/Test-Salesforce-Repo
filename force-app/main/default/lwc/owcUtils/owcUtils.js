...
import OWC_claimant_upload_confirm_doc_2 from '@salesforce/label/c.OWC_claimant_upload_confirm_doc_2';
...
import OWC_claimant_employee_homephone_not_required_msg from '@salesforce/label/c.OWC_claimant_employee_homephone_not_required_msg';
import OWC_claimant_employee_alternate_phone from '@salesforce/label/c.OWC_claimant_employee_alternate_phone';
import OWC_claimant_employee_alternate_contact from '@salesforce/label/c.OWC_claimant_employee_alternate_contact';
import OWC_claimant_employee_alternate_contact_helptext from '@salesforce/label/c.OWC_claimant_employee_alternate_contact_helptext';
import OWC_claimant_employee_alternate_phone_helptext	 from '@salesforce/label/c.OWC_claimant_employee_alternate_phone_helptext';
...
import OWC_Paid_or_Promised from '@salesforce/label/c.OWC_Paid_or_Promised'
...
import OWC_claim_period_error_msg from '@salesforce/label/c.OWC_claim_period_error_msg';
//Label Section
import OWC_label_delete_button from '@salesforce/label/c.OWC_label_delete_button';
import OWC_claim_period_alert_msg from '@salesforce/label/c.OWC_claim_period_alert_msg';
import OWC_claim_period_endDate_error_msg from '@salesforce/label/c.OWC_claim_period_endDate_error_msg';

//Demographic Section
import OWC_OnlineDemographic_Heading from '@salesforce/label/c.OWC_OnlineDemographic_Heading';
import OWC_Demographic_Gender from '@salesforce/label/c.OWC_Demographic_Gender';
import OWC_Demographic_SexualOrientation from '@salesforce/label/c.OWC_Demographic_SexualOrientation';
import OWC_Demographic_Race from '@salesforce/label/c.OWC_Demographic_Race';
import OWC_Demographic_Ethnicity from '@salesforce/label/c.OWC_Demographic_Ethnicity';
import OWC_Demographic_Ethnic_Origin from '@salesforce/label/c.OWC_Demographic_Ethnic_Origin';
import OWC_Demographic_Instruction_Label from '@salesforce/label/c.OWC_Demographic_Instruction_Label';
import OWC_Demographic_heading_text from '@salesforce/label/c.OWC_Demographic_heading_text';
import OWC_garment_final_msg from '@salesforce/label/c.OWC_garment_final_msg';
import OWC_pdf_generation_button from '@salesforce/label/c.OWC_pdf_generation_button';
import OWC_dt16_balance_owed_label from '@salesforce/label/c.OWC_dt16_balance_owed_label';
import OWC_valid_hours_input_error_msg from '@salesforce/label/c.OWC_valid_hours_input_error_msg';
import OWC_manufacturing_duties from '@salesforce/label/c.OWC_manufacturing_duties';
import OWC_manufacturing_duties1 from '@salesforce/label/c.OWC_manufacturing_duties1';
import OWC_manufacturing_duties2 from '@salesforce/label/c.OWC_manufacturing_duties2';
import OWC_manufacturing_duties3 from '@salesforce/label/c.OWC_manufacturing_duties3';
import OWC_manufacturing_duties4 from '@salesforce/label/c.OWC_manufacturing_duties4';
import OWC_manufacturing_duties5 from '@salesforce/label/c.OWC_manufacturing_duties5';
import OWC_manufacturing_duties6 from '@salesforce/label/c.OWC_manufacturing_duties6';
import OWC_manufacturing_duties7 from '@salesforce/label/c.OWC_manufacturing_duties7';
import OWC_manufacturing_duties8 from '@salesforce/label/c.OWC_manufacturing_duties8';
import owc_startdateofclaim from '@salesforce/label/c.owc_startdateofclaim';
import owc_enddateofclaim from '@salesforce/label/c.owc_enddateofclaim';
import owc_paidbypiecerate from '@salesforce/label/c.owc_paidbypiecerate';
import owc_garmentEmp from '@salesforce/label/c.owc_garmentEmp';
import owc_garmentEmpHelpText from '@salesforce/label/c.owc_garmentEmpHelpText';
import OWC_Invalid_BirthDate from '@salesforce/label/c.OWC_Invalid_BirthDate';
import owcWageClaimSubmitError from '@salesforce/label/c.owcWageClaimSubmitError';
import OWCUserGuideOnError2 from '@salesforce/label/c.OWCUserGuideOnError2';
import OWCUserGuideOnError1 from '@salesforce/label/c.OWCUserGuideOnError1';

const customLabelValues = {
    OWCUserGuideOnError2,
    OWCUserGuideOnError1,
    owcWageClaimSubmitError,
    OWC_Invalid_BirthDate,
    owc_garmentEmp,
    owc_garmentEmpHelpText,
    owc_startdateofclaim,
    owc_enddateofclaim,
    owc_paidbypiecerate,
    OWC_pdf_generation_button,
    OWC_garment_final_msg,
    OWC_manufacturing_duties,
    OWC_manufacturing_duties1,
    OWC_manufacturing_duties2,
    OWC_manufacturing_duties3,
    OWC_manufacturing_duties4,
    OWC_manufacturing_duties5,
    OWC_manufacturing_duties6,
    OWC_manufacturing_duties7,
    OWC_manufacturing_duties8,
    OWC_valid_hours_input_error_msg,
    OWC_dt16_balance_owed_label,
    OWC_Demographic_heading_text,
    OWC_Demographic_Instruction_Label,
    //Demographic section
    OWC_OnlineDemographic_Heading,
    OWC_Demographic_Gender,
    OWC_Demographic_SexualOrientation,
    OWC_Demographic_Race,
    OWC_Demographic_Ethnicity,
    OWC_Demographic_Ethnic_Origin,

    OWC_claim_period_endDate_error_msg,
    OWC_claim_period_alert_msg,
    OWC_claim_period_error_msg,
    OWC_file_size_error,
    ...
    OWC_claimant_upload_confirm_doc_2,
    ...
    OWC_claimant_employee_homephone_not_required_msg,
    OWC_claimant_employee_alternate_phone,
    OWC_claimant_employee_alternate_contact,
    OWC_claimant_employee_alternate_contact_helptext,
    OWC_claimant_employee_alternate_phone_helptext,
    OWC_CellPhone,
