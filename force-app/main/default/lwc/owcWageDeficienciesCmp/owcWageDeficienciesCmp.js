...
export default class OwcWageDeficiencies extends LightningElement {
    ...
    handleSectionDelete(event){
        ...
        const wageDefSectionDetails = this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Container-Cmp')
        ...
        // const wageDefTemp = this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Container-Cmp')
    ...
    owcwageDeficienciesFromParent(){
        const details = this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Container-Cmp')
    ...
    handlepaymentofwagesdetails(paymentOfWagesDetails, isFormPreviewMode){
        ...
        const details = this.iswagedefpreview === true ? this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Preview-Cmp') : this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Container-Cmp');
    ...
    handleEmpStatusValue(quitDate, DishargedDate){
        ...
        const temp = this.iswagedefpreview === true ? this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Preview-Cmp') : this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Container-Cmp');
    ...
    renderedCallback(){
        ...
        if(this.isWageDefSectionDeleted === true){
            ...
            const wageDefSectionDetails = this.iswagedefpreview === true ? this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Preview-Cmp') : this.template.querySelectorAll('c-owc-Wage-Deficiencies-Child-Container-Cmp')
            for (let i = 0; i < wageDefSectionDetails.length; i++){
