...
export default class OwcWorkweekAndWorkdayCmp extends LightningElement {
    ...
    isWorkweekAndWorkdayDateAcceptable = false;
        ...
        owcWorkWeekAndWorkDayForParent(){
            ...
            //         if(EndDate.value != null && EndDate.value != '' && EndDate.value !=  undefined){
            //             if(BegDate.value > EndDate.value){
            //                 BegDate.setCustomValidity(customLabelValues.OWC_begdate_error_msg)
            //                 EndDate.setCustomValidity(customLabelValues.OWC_enddate_error_msg)
            //                 EndDate.reportValidity()
            //                 BegDate.reportValidity()
            //                 this.isWorkweekAndWorkdayDateAcceptable = true
            //             }
            //             else{
            //                 this.isWorkweekAndWorkdayDateAcceptable = false
            //             }
            //         }

            //         this.isBegDate = this.begDateValidityChecker(BegDate, BegDateValue);
            //         this.isBegDate === true || this.isWorkweekAndWorkdayDateAcceptable === true ? BegDate.focus() : ''
            //         this.isEndDate = this.dateValidityChecker(EndDate, EndDateValue);
            //         this.isEndDate === true || this.isWorkweekAndWorkdayDateAcceptable === true ? EndDate.focus() : ''
            //         if(this.isBegDate === true || this.EndDate === true || this.isWorkweekAndWorkdayDateAcceptable === true){
            //                 const selectEvent = new CustomEvent('workweekandworkdayvalidityevent', {
            //                     detail: { 
            //                         currentStep : true
            //                     }
